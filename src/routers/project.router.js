...
router.post('/:id/accept-collaboration-invite', isLoggedIn, projectRoutes.acceptInvite);
router.get('/:id/collaborator/token', projectRoutes.checkCollaboratorToken);
router.get('/:id/collaborator', isLoggedIn, projectRoutes.getCollaborators);
router.post('/:id/invite-collaborator', isLoggedIn, projectRoutes.inviteCollaborator);
router.delete('/:id/collaborator', isLoggedIn, projectRoutes.removeCollaborator);
router.delete('/:id/collaborator/:collaboratorId', isLoggedIn, projectRoutes.removeCollaborator);
router.patch('/:id/collaborator/:collaboratorId', isLoggedIn, projectRoutes.updateCollaborator);
